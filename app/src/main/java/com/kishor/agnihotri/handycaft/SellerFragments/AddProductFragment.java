package com.kishor.agnihotri.handycaft.SellerFragments;
...
import com.kishor.agnihotri.handycaft.helper.Constants;
import com.kishor.agnihotri.handycaft.helper.InputValidation;
import com.kishor.agnihotri.handycaft.model.HandiCraft;
            ...
            storageRef.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<TaskSnapshot>() {
                        ...
                        public void onSuccess(TaskSnapshot taskSnapshot) {
                            ...
                            filePath= urlTask.getResult();

                            HandiCraft handiCrafts = new HandiCraft();
                            handiCrafts.setProduct_id(uploadId);
                            handiCrafts.setProduct_image(filePath.toString());
